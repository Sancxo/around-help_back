...
export default function AppProvider({ children }: { children: ReactNode }) {
  ...
  const [address, setAddress] = useState<Address>({ address: "", long_lat: [0, 0] });
...
const AddressContext = createContext({ address: { address: "", long_lat: [0, 0] }, setAddress: (address: Address): void => { } });
